    ...
    <div className="px-6 md:px-0">
      <div className="flex justify-center pl-2 md:pl-12 lg:pl-14">
        <div className="flex flex-col gap-6 md:gap-12 md:pb-20 lg:gap-16 xl:flex-row">
          <h1 className="max-w-80 text-4xl font-semibold leading-10 tracking-tight text-white md:max-w-xl md:text-6xl md:leading-14 lg:max-w-2xl lg:text-7xl lg:leading-16 xl:max-w-3xl">
